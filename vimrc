...
" xsel
" -p is primary, select and middle-click, don't need this
" -s is secondary, disable it though to not get too confusing
" -b is clipboard, ctrl-c ctr-v

" xclip
" -sel p is primary, select and middle-click, don't need this
" -sel s is secondary, disable it though to not get too confusing
" -sel c is clipboard, ctrl-c ctr-v

" Copy to X CLIPBOARD
vmap <leader>cc y:call system("xclip -i -selection clipboard", getreg("\""))<CR>:call system("xclip -i", getreg("\""))<CR>
nmap <leader>vv :call setreg("\"",system("xclip -o -selection clipboard"))<CR>p
